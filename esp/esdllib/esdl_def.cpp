...
public:
    ...
    void loadElement(EsdlDefinition *esdl, XmlPullParser *xpp, StartTag &tag)
    {
        ...
        addChild(dynamic_cast<IEsdlDefObject*>(et));
        et->load(xpp, tag);
    }
    ...
    void loadArray(EsdlDefinition *esdl, XmlPullParser *xpp, StartTag &tag, const bool isEsdlList)
    {
        ...
        addChild(dynamic_cast<IEsdlDefObject*>(art));
        art->load(xpp, tag);
    }
    ...
    void loadAttribute(EsdlDefinition *esdl, XmlPullParser *xpp, StartTag &tag)
    {
        ...
        addChild(dynamic_cast<IEsdlDefObject*>(at));
        at->load(xpp, tag);
    }
    ...
    void loadEnumRef(EsdlDefinition *esdl, XmlPullParser *xpp, StartTag &tag)
    {
        ...
        addChild(dynamic_cast<IEsdlDefObject*>(er));
        er->load(xpp,tag);
    }
